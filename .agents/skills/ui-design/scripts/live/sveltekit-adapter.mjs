...
export const SVELTE_ROOT_IMPORT = "import UizzeLiveRoot from '$lib/uizze/UizzeLiveRoot.svelte';";
...
const SVELTE_ROOT_IMPORT_LINE_RE = /^[ \t]*import UizzeLiveRoot from '\$lib\/uizze\/UizzeLiveRoot\.svelte(?:\?[^']*)?';[ \t]*\r?\n?/gm;
...
export function svelteRootImportLine(rev) {
  ...
  return "import UizzeLiveRoot from '$lib/uizze/UizzeLiveRoot.svelte?uizze-live=" + rev + "';";
}
