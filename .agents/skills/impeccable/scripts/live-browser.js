...
(function () {
  ...
  const LIVE_UI_SURFACES = Array.isArray(window.__IMPECCABLE_LIVE_UI_SURFACES__) ? window.__IMPECCABLE_LIVE_UI_SURFACES__ : [];
...
void main() {
  ...
  function restoreSessionSupersedingHandledWrapper(runtimeWrapper) {
    const handledSessionId = runtimeWrapper?.dataset?.impeccableVariants || runtimeWrapper?.dataset?.impeccableCarbonize;
