...
const CANONICAL_SECTIONS = ["Overview", "Colors", "Typography", "Layout", "Elevation", "Shapes", "Components", "Do's and Don'ts"];
...
function extractOverview(section) {
  ...
  const prose = keyCharMatch ? text.slice(0, keyCharMatch.index) + text.slice(keyCharMatch.index + keyCharMatch[0].length) : text;
