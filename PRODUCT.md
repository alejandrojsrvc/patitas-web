...
Personas responsables de perros o gatos que compran regularmente alimento y otros consumibles, y quieren delegar el recuerdo y la organización de esas reposiciones.
...
- Nombre: Patitas Inquietas.
- Voz cercana, clara, confiable y rioplatense.
- La identidad visual oficial está definida en `docs/PATITAS_VISUAL_GUIDE.md`.
- Los logos oficiales están en `public/brand/`.

## Evidence on Hand

No hay todavía testimonios, métricas, fotografías propias ni afirmaciones comerciales verificadas. La landing no debe fabricarlos.
