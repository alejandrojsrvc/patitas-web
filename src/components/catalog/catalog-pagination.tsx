  ...
  return (
    <nav aria-label="Paginación del catálogo" className="mt-10 flex items-center justify-center gap-3">
      <Link
        ...
        href={catalogHref(pathname, current, { page: Math.max(1, result.meta.page - 1) })}
        scroll={false}
      ...
      <Link
        ...
        href={catalogHref(pathname, current, { page: Math.min(result.meta.totalPages, result.meta.page + 1) })}
        scroll={false}
