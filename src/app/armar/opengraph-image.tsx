...
export const alt = "Patitas Inquietas: armá el plan de abastecimiento de tu mascota";
...
export default async function OpenGraphImage() {
  ...
  return new ImageResponse(
    ...
    >
      <img src={logoSrc} alt="" width={390} height={43} style={{ objectFit: "contain" }} />
      <div style={{ display: "flex", alignItems: "flex-end", gap: 56 }}>
        <div style={{ display: "flex", flexDirection: "column", width: 810 }}>
          ...
          <div style={{ marginTop: 28, fontSize: 29, color: "#686868" }}>
            Respondí unas preguntas y armá un plan a medida de tu mascota.
          </div>
        </div>
        <div
          style={{
        ...
        >
          <img src={isotypeSrc} alt="" width={102} height={122} style={{ objectFit: "contain" }} />
        </div>
      </div>
      <div
        style={{
